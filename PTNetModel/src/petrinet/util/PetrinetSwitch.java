	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			...
			case PetrinetPackage.NODE: {
				...
				if (result == null) result = caseEClass(node);
				if (result == null) result = caseEClassifier(node);
			...
			case PetrinetPackage.TRANSITION: {
				...
				if (result == null) result = caseEClass(transition);
				if (result == null) result = caseEClassifier(transition);
			...
			case PetrinetPackage.PLACE: {
				...
				if (result == null) result = caseEClass(place);
				if (result == null) result = caseEClassifier(place);
				if (result == null) result = caseENamedElement(place);
				if (result == null) result = caseEModelElement(place);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
