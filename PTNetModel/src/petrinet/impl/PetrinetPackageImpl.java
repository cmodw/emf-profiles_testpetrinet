...
public class PetrinetPackageImpl extends EPackageImpl implements PetrinetPackage {
	 ...
	 * @generated
	 */
	public EOperation getArc__IsEnabled() {
		return arcEClass.getEOperations().get(0);
	}
	 ...
	 * @generated
	 */
	public EOperation getTransition__IsEnabled() {
	 ...
	 * @generated
	 */
	public EOperation getPlace__HasCapacity__int() {
	...
	public void createPackageContents() {
		...
		createEOperation(arcEClass, ARC___IS_ENABLED);
		...
		createEOperation(transitionEClass, TRANSITION___IS_ENABLED);

		placeEClass = createEClass(PLACE);
		createEReference(placeEClass, PLACE__TOKENS);
		createEAttribute(placeEClass, PLACE__CAPACITY);
		createEOperation(placeEClass, PLACE___HAS_CAPACITY__INT);
	...
	public void initializePackageContents() {
		...
		nodeEClass.getESuperTypes().add(theEcorePackage.getEClass());
		...
		initEOperation(getArc__IsEnabled(), ecorePackage.getEBoolean(), "isEnabled", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEOperation(getTransition__IsEnabled(), ecorePackage.getEBoolean(), "isEnabled", 1, 1, IS_UNIQUE, IS_ORDERED);
		...
		initEAttribute(getPlace_Capacity(), ecorePackage.getEInt(), "capacity", "-1", 0, 1, Place.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

		EOperation op = initEOperation(getPlace__HasCapacity__int(), ecorePackage.getEBoolean(), "hasCapacity", 1, 1, IS_UNIQUE, IS_ORDERED);
