 ...
 *   <li>{@link petrinet.impl.PlaceImpl#getCapacity <em>Capacity</em>}</li>
 * </ul>
 *
 * @generated
 */
public class PlaceImpl extends NodeImpl implements Place {
	...
	public boolean hasCapacity(int amount) {
		if(this.capacity < 0)
			return true;
		if(amount + getTokens().size() > this.capacity)
			return false;
		return true;
	}
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
			case PetrinetPackage.PLACE___HAS_CAPACITY__INT:
				return hasCapacity((Integer)arguments.get(0));
		}
